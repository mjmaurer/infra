...
PROMPT="Generate a descriptive but concise git commit message based on these staged changes. Follow the conventional commits specification. Here are the changes:
