...
let
  python3 = pkgs-latest.python3;
in
{
  claude-trace = pkgs-latest.buildNpmPackage rec {
    pname = "claude-trace";
    version = "1.0.8";
  ...
  claude-trace-viewer = python3.pkgs.buildPythonApplication rec {
    pname = "claude-trace-viewer";
    version = "0.2.1";
    pyproject = true;

    src = pkgs-latest.fetchFromGitHub {
      owner = "bkrabach";
      repo = "claude-trace-viewer";
      rev = "v${version}";
      hash = "sha256-ZYVycfU3xRcWfQM66IPlN36MhnZ2zn7NhsMKfkY90qA=";
    };
    ...
    meta = {
      description = "Web-based viewer for logs generated by claude-trace";
      homepage = "https://github.com/bkrabach/claude-trace-viewer";
      license = lib.licenses.mit;
      mainProgram = "claude-trace-viewer";
    };
  };
}
