        ...
        if isDarwin then
          {
            ...
            launchd.daemons.Karabiner-DriverKit-VirtualHIDDevice-Daemon = {
              ...
              command = ''"${karabiner-package.driver}/Library/Application Support/org.pqrs/Karabiner-DriverKit-VirtualHIDDevice/Applications/Karabiner-VirtualHIDDevice-Daemon.app/Contents/MacOS/Karabiner-VirtualHIDDevice-Daemon"'';
              serviceConfig.ProcessType = "Interactive";
              serviceConfig.Label = "org.pqrs.Karabiner-VirtualHIDDevice-Daemon";
              serviceConfig.RunAtLoad = true;
              serviceConfig.KeepAlive = true;
              serviceConfig.StandardOutPath = "/Library/Logs/Karabiner-Driverkit-Daemon/out.log";
              serviceConfig.StandardErrorPath = "/Library/Logs/Karabiner-Driverkit-Daemon/error.log";
            };
            ...
            launchd.user.agents.activate_karabiner_system_ext = {
              ...
              serviceConfig.RunAtLoad = true;
              serviceConfig.StandardOutPath = "/Users/${username}/Library/Logs/Karabiner-activate/out.log";
              serviceConfig.StandardErrorPath = "/Users/${username}/Library/Logs/Karabiner-activate/error.log";
            };
          }
        else
          # NixOS
